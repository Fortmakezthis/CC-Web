...
# How to install web
There are two ways to install web and dependencies. The first is downloading wubDater.lua from here, dragging it onto a computer in Minecraft, and running it.
